export const CONFIG: {
    ...
    '824247070589': {
        ...
        availableChainNames: 'abstract,ape,aptos,arbitrum,astar,aurora,avalanche,base,bb1,bera,bitlayer,blast,bob,bsc,canto,celo,codex,conflux,coredao,cronosevm,cronoszkevm,cyber,degen,dexalot,dfk,dm2verse,dos,ebi,edu,ethereum,etherlink,fantom,flare,flow,fraxtal,fuse,glue,gnosis,goat,gravity,harmony,hemi,joc,ink,iota,islander,kava,klaytn,lightlink,manta,mantle,masa,merlin,meter,metis,mode,moonbeam,moonriver,morph,mp1,opbnb,optimism,orderly,peaq,plume,polygon,rarible,real,rootstock,scroll,sei,shimmer,solana,soneium,sonic,sophon,story,superposition,swell,taiko,telos,tomo,ton,tron,unichain,worldchain,xai,xchain,xlayer,xpla,zircuit,zkconsensys,zkpolygon,zksync,zora',
